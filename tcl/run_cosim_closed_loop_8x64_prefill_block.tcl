...
set project_name [llm_fpga_profiled_project_name qwen_hls_closed_loop_8x64_prefill_block_cosim_prj]
append project_name [llm_fpga_depth_project_suffix]
open_project -reset $project_name
set_top cc8_closed_loop_inner_cosim
set cflags "-I./include -std=c++14 -DCC8_CLOSED_LOOP_PREFILL_BLOCK_COSIM -DCC8_PREFILL_BLOCK_SYNTH_ONLY[llm_fpga_model_cflags][llm_fpga_depth_cflags]"
