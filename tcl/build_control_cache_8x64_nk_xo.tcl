...
set_top $kernel_name
add_files [file join $repo_root kernel/mm_controller.cpp] -cflags $cflags
add_files [file join $repo_root kernel/control_cache_8x64.cpp] -cflags $cflags
add_files [file join $repo_root kernel/control_cache_8x64_nk.cpp] -cflags $cflags
