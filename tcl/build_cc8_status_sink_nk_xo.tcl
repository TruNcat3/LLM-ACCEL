...
if {[info exists ::env(LLM_FPGA_HLS_PROJECT_NAME)] &&
    ...
    set project_name [llm_fpga_profiled_project_name qwen_hls_cc8_status_sink_nk_prj]
}
...
set cflags "-I[file normalize include] -std=c++14[llm_fpga_model_cflags]"
...
set_top $kernel_name
add_files [file join $repo_root kernel/cc8_status_sink.cpp] -cflags $cflags
