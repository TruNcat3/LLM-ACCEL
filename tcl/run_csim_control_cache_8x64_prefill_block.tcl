...
set project_name [llm_fpga_profiled_project_name qwen_hls_control_cache_8x64_prefill_block_csim_prj]
append project_name [llm_fpga_depth_project_suffix]
open_project -reset $project_name
set_top control_cache_8x64_dual_core
set cflags "-I./include -std=c++14 -DCC8_PREFILL_BLOCK_TEST_ONLY -DCC8_PREFILL_BLOCK_SYNTH_ONLY[llm_fpga_model_cflags][llm_fpga_depth_cflags]"
